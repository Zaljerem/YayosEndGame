...
namespace yayoEnding
{
    ...
    public class YayoEndingWorldComponent : WorldComponent
    {
        ...
        private void UpdatePlanetCoreRecipes()
        {
            if (YayoEndingMod.DebugLogging) Log.Message("[YayoEnding] :: WorldLoaded - updating planet core recipes");
            ...
            foreach (var tile in Find.WorldGrid.Tiles)
            {
                ...
                if (DefDatabase<ThingDef>.GetNamedSilentFail(gemDefName) == null) continue;
